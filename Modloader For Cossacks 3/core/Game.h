...
//
// События (Events):
//   game.menu     — главное меню (первый такт после его создания — интерфейс готов)
//   game.prepare  — подготовка новой партии (DoNewGame)
//   game.start    — партия создана, игроки есть, интерфейс построен (первый такт после DoCreate)
